...
describe("API tests", async function () {
    ...
    // it("circulating supply", async function () {

       
    //     console.log(1)  
    //         let req = await chai.request(server).get("/circulatingSupply/").send()
    //    console.log("tst circsupply", req)
    //         //expect(req.text).contains("circulatingSupply")
